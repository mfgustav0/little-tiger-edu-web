...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-blue-900 to-slate-900 text-white p-4 flex items-center justify-center flex-col">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm p-6 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-150">
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold mb-1 text-white">Aprenda Jogando</h3>
                <p className="text-sm text-slate-300">
                  Gire a roleta e responda perguntas de Matemática e História.
                  Cada acerto rende moedas!
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-300">
                  Perguntas aleatórias testam seu raciocínio. Errou? Aprenda com
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-300">
                  Veja suas estatísticas, precisão e evolua de Iniciante até
                  Mestre!
                </p>
              </div>
            </div>
        ...
        <div className="text-center animate-in fade-in duration-700 delay-500">
          <p className="text-xs text-slate-500">
            <span className="font-semibold">Educacional.</span> Sem apostas. Use
            em contexto orientado por educador.
          </p>
        </div>
      </div>
    </div>
